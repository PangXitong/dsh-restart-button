...
// The client-module id MUST match the npm package name: DSH's client-modules
// loader keys modules by package name, so __ModuleLoader__.load({ id }) has
// to be the full "@pangxitong/dsh-restart-button", not a short slug.
const CLIENT_MODULE_ID = '@pangxitong/dsh-restart-button';
